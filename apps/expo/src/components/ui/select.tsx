...
const SelectTrigger = React.forwardRef<TriggerRef, TriggerProps>(
...
const SelectLabel = React.forwardRef<LabelRef, LabelProps>(
  ({ className, ...props }, ref) => (
...
const SelectSeparator = React.forwardRef<SeparatorRef, SeparatorProps>(
  ({ className, ...props }, ref) => (
